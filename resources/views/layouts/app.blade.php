    ...
    <div class="row">
        <div class="col-md-2 sidebar px-0">
            ...
            <a href="{{ route('dashboard') }}"
               class="nav-link-cms {{ request()->routeIs('dashboard') ? 'active' : '' }}">
               Dashboard
            </a>
            <a href="{{ route('artikel.index') }}"
               class="nav-link-cms {{ request()->routeIs('artikel.*') ? 'active' : '' }}">
               Kelola Artikel
            </a>
            <a href="{{ route('penulis.index') }}"
               class="nav-link-cms {{ request()->routeIs('penulis.*') ? 'active' : '' }}">
               Kelola Penulis
            </a>
            <a href="{{ route('kategori.index') }}"
               class="nav-link-cms {{ request()->routeIs('kategori.*') ? 'active' : '' }}">
               Kelola Kategori
            </a>
