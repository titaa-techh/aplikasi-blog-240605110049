...
<body>
    ...
    <div class="login-card">
        ...
        <?php if(session()->has('loginError')): ?>
            <div class="alert alert-danger py-2 px-3 style='font-size:13px;'"><?php echo e(session('loginError')); ?></div>
        <?php endif; ?>
...
</html><?php /**PATH C:\xamppp\htdocs\aplikasi-blog\resources\views/login.blade.php ENDPATH**/ ?>