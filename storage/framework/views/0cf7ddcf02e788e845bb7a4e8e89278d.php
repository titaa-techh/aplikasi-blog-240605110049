...
<nav class="navbar-blog">
    <div class="container d-flex justify-content-between align-items-center">
        ...
        <div>
            <a href="<?php echo e(route('beranda')); ?>" class="nav-link d-inline">Beranda</a>
            <a href="<?php echo e(route('beranda')); ?>" class="nav-link d-inline">Artikel</a>
            <a href="<?php echo e(route('beranda')); ?>" class="nav-link d-inline">Kategori</a>
...
</html><?php /**PATH C:\xamppp\htdocs\aplikasi-blog\resources\views/layouts/publik.blade.php ENDPATH**/ ?>